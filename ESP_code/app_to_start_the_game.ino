...
void addTestField(String patientId, String testName, String newTestName, String value,int newTestNumber) {
  ...
  HTTPClient http;
  String url = String(firebaseHost) + "/patients/" + patientId + "/results/" + testName + "?updateMask.fieldPaths=" + newTestName + "&access_token=" + idToken;
  ...
  doc["fields"]["tests_number"]["intValue"] = newTestNumber;
