...
*/
  ...
  Future<void> addPatient() async {
    try {
      await FirebaseFirestore.instance.collection('patients').doc(_model.fullNameTextController!.text.trim()).set({
    ...
    try {
      await FirebaseFirestore.instance.collection('users').doc(UID).update({
        'patients': FieldValue.arrayUnion([_model.fullNameTextController!.text.trim()]),
      });
