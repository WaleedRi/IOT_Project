    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
            height: 450,
            child: SuccessRateGraph(successRates: successRates,max_y: max_y,colorgraph: colorgraph,),
          ),
        ],
      ),
    );
   ...
   //   width: MediaQuery.of(context).size.width * 0.48,
      ...
      child: Column(
        children: [
         ...
         //   child: Text(
              child: SuccessRateGraph(successRates: successRates,max_y: max_y,colorgraph:colorgraph,),              //  placeholder,
