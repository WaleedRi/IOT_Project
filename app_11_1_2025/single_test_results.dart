...
class SingleTestResultWidget extends StatefulWidget {
  const SingleTestResultWidget({super.key});
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            _buildTestHistoryItem(context, 'First Attempt', 'June 15, 2023', '5'),
            const SizedBox(height: 16),
            _buildTestHistoryItem(context, 'Second Attempt', 'June 16, 2023', '5'),
            const SizedBox(height: 16),
            _buildTestHistoryItem(context, 'Third Attempt', 'June 17, 2023', '4'),
          ],
        ),
      ),
    );
