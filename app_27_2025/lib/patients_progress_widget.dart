...
class _PatientsProgressWidgetState extends State<PatientsProgressWidget> {
  ...
  void updateTestLevel(String pateintName, String level) {
    setState(() {
      overduePatients[pateintName] = level;
    });
  }
      ...
      if (snapshot.exists) {
        ...
        for (int i = 0; i < PateintsNameAndId.length; i++) {
            ...
            if(lastTest!=0){
              ...
              if (lastTestDate != null) {
                ...
                if (now.difference(lastTest).inDays > 7) {
                  updateTestLevel(patientId, 'Tests Outdated');
              ...
              updateTestLevel(patientId, 'Tests Not Taken');
          ...
          if(isOutdated== false){
            ...
            updateTestLevel(patientId, 'Tests Completed');
          }
