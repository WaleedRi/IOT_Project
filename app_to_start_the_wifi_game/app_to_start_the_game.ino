...
const char* ssid = "Thaerphone";
const char* password = "thaer1234";
...
/*void setup() {
    ...
    // Set up HTTP server
    server.on("/start-test", startTestHandler);
    server.begin();
...
void setup() {
  ...
  Serial.println(WiFi.localIP()); // Prints the IP address
    // Automatically connect to a saved network or start AP for new credentials
